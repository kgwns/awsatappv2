...
export enum ImagesName {
  ...
  greenPlayIconName = 'greenPlayIcon',
  notification = 'notification',
  notificationSelected = 'notificationSelected',
  sunCloudsName = 'sunClouds',
  arrowPrev = 'arrowPrev',
  arrowNext = 'arrowNext',
  ...
  returnIconName = 'returnIcon',
  mail = 'mail',
  mailSelected = 'mailSelected',
  earlyEditionImgName = 'earlyEditionImg',
  moneyAndBusinessImgName = 'moneyAndBusinessImg',
  technologyImgName = 'technologyImg',
  ...
  placeholderImgName = 'placeholderImg',
  ...
  authorDefaultName = 'authorDefault',
  ...
  flagIcon = 'flagIcon',
  popupLogo = 'popupLogo',
  crosswordImageName = 'crosswordImage',
  sudokuImageName = 'sudokuImage',
  crosswordImageDarkName = 'crosswordImageDark',
  sudokuImageDarkName = 'sudokuImageDark',
  subscribeIconWhite = 'subscribeIconWhite',
  subscribeIconGreen = 'subscribeIconGreen',
  archiveIconLightImage = 'archiveIconLight',
  archiveIconDarkImage = 'archiveIconDark',
