...
describe('<PhotoGalleryDetailFooter>', () => {
    ...
    beforeEach(() => {
        const component = (
            <PhotoGalleryItem item={data} isBookmarked={false} title={mockString} imageUrl={mockString} nid={mockString} created={new Date()} onUpdateBookmark={mockFunction} onPress={mockFunction} />
        );
