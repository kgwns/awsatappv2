...
describe('<OpinionArticleDetailFooter>', () => {
    ...
    writer: [
      {
        ...
        opinion_writer_photo:
          'http://srpcawsatdev.prod.acquia-sites.com/sites/default/files/styles/304x292/public/2021/01/13/1375877443597951100.jpg?itok=lW-Sn5Xw',
        langcode: 'Arabic',
        name: 'عثمان ميرغني',
      },
    ],
  ...
  beforeEach(() => {
    const component = (
      <OpinionArticleDetailFooter opinionArticleDetailData={data} />
    );
