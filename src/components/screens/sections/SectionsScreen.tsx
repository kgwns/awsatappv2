...
export const SectionsScreen = () => {
  ...
  const updateSwipeLeftPager = async (props: any, route: any, inProgressIndex: number, newIndex: number) => {
    console.log("🚀 ~ file: SectionsScreen.tsx ~ line 111 ~ updateMorePager ~ newIndex", newIndex)
    console.log("🚀 ~ file: SectionsScreen.tsx ~ line 111 ~ updateMorePager ~ inProgressIndex", inProgressIndex)
