...
Open terminal and go to the project directory (i.e, documents -> awsatapp).
enter the command "yarn install" or "npm install".

For iOS one more step :
go to the ios folder inside the project directory (i.e, documents -> awsatapp -> ios ) in the terminal.
